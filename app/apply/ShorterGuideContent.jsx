		...
		>
			...
			<div className="flex justify-center mb-[1vh]" style={{ padding: "0 7.2%" }}>
				<div
					...
					style={{ border: "4px solid #0E387A", padding: "2vw 3.5vw" }}
				>
					<p style={{ fontSize: "1.6vw", color: "#0E387A", lineHeight: 1.5, marginBottom: "1.5vh" }}>
					...
					<p style={{ fontSize: "1.6vw", color: "#0E387A", lineHeight: 1.5, fontWeight: 700 }}>
