	...
	return (
		<div className="flex flex-col gap-1">
			...
			<input
				...
				className="outfit bg-white w-full px-3 py-1.5 text-[1.2vw] text-[#2E599C] border-[3px] border-[#0e387a] rounded-2xl outline-none focus:border-[#0e387a] transition-colors placeholder:text-[#b0c4de]"
			/>
		</div>
	);
}
			...
			<div className="relative mx-[2.5%] mt-[7vh] mb-[4vh]">
				...
				<div className="relative z-10 w-[82%] mx-auto pt-[5vh] pb-[6vh]">
					...
					>
						...
						<Field
							label="Pronouns"
							hint="You must be a girl or girl identifying to organize a Sunbeam!"
							name="pronouns"
							value={form.pronouns}
							onChange={set}
						/>
