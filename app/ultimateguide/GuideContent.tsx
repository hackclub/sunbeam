	...
	return (
		<div>
			...
			<div className="text-center pt-[6vh] pb-[4vh]">
				<p className="galindo" style={{ fontSize: "3.10em", color: "#359BBF", lineHeight: 1.2 }}>
					QUICKSTART GUIDE
				</p>
				<p className="galindo" style={{ fontSize: "2.33em", color: "#72BFDA", lineHeight: 1.2 }}>
					(very important!!)
				</p>
			</div>
			...
			<div className="flex justify-center mb-[1vh]" style={{ padding: "0 7.2%" }}>
				<div
					...
					style={{ border: "0.25em solid #0E387A", padding: "3.5em 5em" }}
				>
					...
					<p style={{ fontSize: "1.94em", color: "#0E387A", lineHeight: 1.6, fontWeight: 700 }}>
			...
			<div className="text-center pb-[3vh]" style={{ padding: "0 9.1% 3vh" }}>
				<p style={{ fontSize: "2.33em", fontWeight: 700, color: "rgb(46,88,155)", lineHeight: 1.4 }}>
			...
			<div
				...
				style={{ display: "grid", padding: "0 9.1%", gap: "4vh 4em", marginBottom: "4vh" }}
			>
				{[
					...
					<div key={i} className="flex flex-col items-center">
						...
						/>
						<p className="text-center mt-[1.5vh]" style={{ fontSize: "1.7em", color: "rgb(46,88,155)"}}>
							{caption}
						</p>
					</div>
				))}
			...
			<div className="text-center pb-[5vh]" style={{ padding: "0 9.1% 5vh" }}>
				<p style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.4 }}>
			...
			<div className="galindo text-center pt-[5vh] pb-[3vh]">
				<p style={{ fontSize: "2.91em", lineHeight: 1.3, marginBottom: "3vh" }}>
			...
			<div
				...
				style={{ display: "flex", padding: "0 7.4% 1vh", gap: "3em", alignItems: "center" }}
			>
				<div style={{ flex: "1 1 0", minWidth: 0 }}>
					<p style={{ fontSize: "1.72em", color: "rgb(46,88,155)", lineHeight: 1.5, marginBottom: "1.5vh" }}>
					...
					<br></br>
					<p style={{ fontSize: "1.72em", color: "rgb(46,88,155)", lineHeight: 1.5 }}>
						This event is more of a <strong>SOCIAL coding get together</strong> than a hackathon!!!
					</p>
				</div>
				<div style={{ flexShrink: 0, width: "13em", background: "#FBF0F3", display: "flex", flexDirection: "column", gap: "0.5vh", padding: "0.5em", border: "0.2em solid #0E387A", transform: "rotate(5deg)", transformOrigin: "top center", position: "relative", left: '1em', top: '-0.5em' }}>
					{[1, 2, 3, 4, 5].map((n) => (
						<img
							key={n}
							src={`/imgs/guide/sidebar-${n}.webp`}
							alt=""
							style={{ width: "100%", display: "block", position: "relative", right: '0.1em', transform: "rotate(-2deg)", transformOrigin: "top center"  }}
						/>
					))}
				</div>
			</div>
			...
			<div style={{ padding: "4vh 7.4%" }}>
				...
				{/* Step 1: Slack */}
				<div style={{ display: "flex", gap: "3em", alignItems: "flex-start", marginBottom: "5vh" }}>
					<div style={{ flex: "1 1 0" }}>
						<p style={{ fontSize: "2.33em", fontWeight: 700, color: "#2E599C", lineHeight: 1.4, marginBottom: "1.5vh" }}>
							1) JOIN HACK CLUB SLACK!! And the #sunbeam channels:
						</p>
						<p style={{ fontSize: "2.33em", fontWeight: 400, color: "#2E599C", lineHeight: 1.6, marginLeft: "3em"}}>
				...
				<div style={{ marginBottom: "5vh" }}>
					<div style={{ display: "flex", gap: "3em", alignItems: "flex-start", marginBottom: "3vh" }}>
						<div style={{ flex: "1 1 0" }}>
							<p style={{ fontSize: "2.62em", fontWeight: 700, color: "#2E599C", lineHeight: 1.4, marginBottom: "1.5vh" }}>
								2) (avengers) Assemble a team of 3-6 organizers!
							</p>
							<p style={{ fontSize: "2.33em", fontWeight: 400, color: "#2E599C", lineHeight: 1.6, marginBottom: "1.5vh", marginLeft: "3em" }}>
					...
					<div
						...
						style={{ display: "flex" }}
					>
						<p style={{ fontSize: "2.04em", fontWeight: 400, color: "#0E387A", lineHeight: 1.6, marginBottom: "3vh", marginRight: "2em"}}>
						...
						<div style={{ flexShrink: 0, width: "35em", position: "relative", top: "-1em" }}>
					...
					<div style={{ border: "0.2em solid #0E387A", marginBottom: "3vh", borderRadius: "1em", overflow: "hidden" }}>
						<div style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
							<div style={{ backgroundColor: "rgba(243,147,180,1)", padding: "0 2em", height: "4em", width:"100%", display: "flex", alignItems: "center", justifyContent: "center", borderRight: "0.2em solid #0E387A", borderBottom: "0.2em solid #0E387A" }}>
								<p style={{ fontSize: "1.94em", fontWeight: 500, color: "#0E387A", textAlign: "center" }}>YUP ✅</p>
							</div>
							<div style={{ backgroundColor: "rgba(249,166,54,1)", padding: "0 2em", height: "4em", width:"100%", display: "flex", alignItems: "center", justifyContent: "center", borderBottom: "0.2em solid #0E387A" }}>
								<p style={{ fontSize: "1.94em", fontWeight: 500, color: "#0E387A", textAlign: "center" }}>NOPE ❌</p>
							</div>
							<div style={{ backgroundColor: "white", padding: "2em 1em", borderRight: "0.2em solid #0E387A" }}>
							...
							<div style={{ backgroundColor: "white", padding: "2em 1em" }}>
								<ul style={{ listStyleType: "disc", paddingLeft: "1.5em" }}>
									<li style={{ fontSize: "1.94em", fontWeight: 400, color: "#0E387A", lineHeight: 1.6 }}>
					...
					<p style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6 }}>
				...
				<div style={{ marginBottom: "5vh" }}>
					<p style={{ fontSize: "2.62em", fontWeight: 700, color: "rgb(46,88,155)", lineHeight: 1.4, marginBottom: "1.5vh" }}>
					...
					<div
						className="flex-col sm:flex-row"
						style={{ display: "flex", gap: "3em", alignItems: "center", marginBottom: "3vh" }}
					>
						<p style={{ fontSize: "2.33em", fontWeight: 400, color: "#2E599C", lineHeight: 1.6, flex: "1 1 0", marginLeft: "3em" }}>
							Want a city@sunbeam.<wbr />hackclub.com email? This will be coming to event PoCs soon! This is a shared Google Workspace account that the team can use to send out mass, personalised communications to attendees, and should be the contact email listed on your website so people can ask you questions.
						</p>
						<div style={{ flexShrink: 0, width: "18em", position: "relative" }}>
							<img src="/imgs/guide/hcb-setup.webp" alt="Gmail" style={{ width: "100%", display: "block" }} />
							<img src="/imgs/sunbeam.webp" alt="" style={{ position: "absolute", bottom: "5em", left: "50%", transform: "translateX(-50%)", width: "10em" }} />
						</div>
					</div>

					{/* HCB row: logo left, text right */}
					<div style={{ display: "flex", gap: "3em", alignItems: "center", marginLeft: "3em" }}>
						<img src="/imgs/guide/hcb-logo.webp" alt="HCB logo" style={{ flexShrink: 0, width: "8em" }} />
						<p style={{ fontSize: "2.33em", fontWeight: 400, color: "#2E599C", lineHeight: 1.6, flex: "1 1 0" }}>
				...
				<div
					className="flex-col sm:flex-row"
					style={{ display: "flex", gap: "3em", alignItems: "center", marginBottom: "8vh" }}
				>
					...
					<div style={{ flex: "1 1 0", minWidth: 0 }}>
						...
						<div style={{ marginBottom: "5vh" }}>
							...
							<p style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6, marginLeft: "3em" }}>
						...
						<div>
							...
							<p style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6, marginBottom: "2vh", marginLeft: "3em" }}>
								A <strong>good</strong> Sunbeam social generally only needs three things:
							</p>
							<ul style={{ listStyleType: "disc", paddingLeft: "3em", marginBottom: "2vh", marginLeft: "3em"  }}>
								<li style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6 }}>
									Food
								</li>
								<li style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6 }}>
									Food
							...
							<p style={{ fontSize: "2.62em", fontWeight: 400, color: "#C54390", lineHeight: 1.4, marginLeft: "3em" }}>
					...
					<div style={{ flexShrink: 0, width: "30em", display: "flex", flexDirection: "column", alignItems: "center", gap: "1vh", position: "relative", top: "2em" }}>
						<img src="/imgs/guide/website-template.webp" alt="Website template" style={{ width: "100%" }} />
						<p style={{ fontSize: "1.74em", fontWeight: 600, color: "#0E387A"}}>cool...</p>
					</div>
				</div>
			...
			<div style={{marginLeft: "7.4%", marginRight: "7.4%", marginBottom: "5vh"}}>
							<div>
								<div
									className="grid-cols-1 p-0 px-[16.7%] sm:grid-cols-3 sm:px-0"
									style={{ display: "grid", gap: "2em", marginBottom: "2vh" }}
								>
									{[
										...
										<div key={n} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1vh" }}>
											...
											<p style={{ fontSize: "1.74em", fontWeight: 400, color: "#0E387A", textAlign: "center", lineHeight: 1.5 }}>{caption}</p>
										</div>
									))}
								</div>
								<div
									className="grid-cols-1 sm:grid-cols-2"
									style={{ display: "grid", gap: "2em", padding: "0 16.7%", marginBottom: "3vh" }}
								>
									{[
							...
							<p style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6, marginBottom: "3vh" }}>
							...
							<ul style={{ listStyleType: "disc", paddingLeft: "3em", marginBottom: "3vh", fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6 }}>
								<li style={{ fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6 }}>
							...
							<p style={{ fontSize: "2.62em", fontWeight: 700, color: "rgb(46,88,155)", lineHeight: 1.4, marginBottom: "1vh" }}>
								Payouts FROM US!!
							</p>
							...
							<p className="text-center" style={{ fontSize: "2.62em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.4, marginBottom: "1vh" }}>
								<strong>$/Signup</strong> is based on the <strong>number of signups you have.</strong>
							</p>
							<p className="text-center" style={{ fontSize: "1.74em", fontWeight: 400, color: "#359BBF", lineHeight: 1.4, marginBottom: "3vh", textDecoration: "underline" }}>
								These rates are for <strong>North America</strong>: more guidance on international payouts coming soon
							</p>

							{/* Payout table */}
							<div style={{ border: "0.2em solid #0E387A", marginBottom: "2vh", borderRadius: "1em", overflow: "hidden" }}>
								<div style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
									<div style={{ background: "rgba(243,147,180,0.65)", padding: "0 2em", height: "4em", display: "flex", alignItems: "center", justifyContent: "center", borderRight: "0.2em solid #0E387A", borderBottom: "0.2em solid #0E387A" }}>
										<p style={{ fontSize: "1.94em", fontWeight: 500, color: "#0E387A", textAlign: "center" }}># of signups</p>
									</div>
									<div style={{ background: "rgba(249,166,54,0.65)", padding: "0 2em", height: "4em", display: "flex", alignItems: "center", justifyContent: "center", borderBottom: "0.2em solid #0E387A" }}>
										<p style={{ fontSize: "1.94em", fontWeight: 500, color: "#0E387A", textAlign: "center" }}>$/Signup</p>
									</div>
								</div>
								{[["0-59", "$8.50"], ["60-119", "$10.00"], ["120+", "$12.00"]].map(([range, rate], i) => (
									<div key={i} style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
										<div style={{ padding: "2vh 2em", textAlign: "center", borderRight: "0.2em solid #0E387A", borderTop: "0.2em solid #0E387A", background: "rgba(255,255,255,0.65)" }}>
											<p style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)" }}>{range}</p>
										</div>
										<div style={{ padding: "2vh 2em", textAlign: "center", borderTop: "0.2em solid #0E387A", background: "rgba(255,255,255,0.65)" }}>
											<p style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)" }}>{rate}</p>
										</div>
									</div>
								))}
							</div>
			...
			<div style={{ padding: "4vh 7.4%" }}>
				...
				<div style={{ marginBottom: "5vh" }}>
					...
					>
						...
						<div style={{ flexShrink: 0, width: "18.1em" }}>
							<img src="/imgs/guide/venue.webp" alt="Venue" style={{ width: "100%", display: "block" }} />
						</div>
					</div>

					{/* Shark + speech bubble row */}
					<div style={{ display: "flex", alignItems: "flex-end", gap: "2em", marginBottom: "2vh", marginTop: "1vh" }}>

						{/* Shark */}
						<img src="/imgs/guide/shark.webp" alt="Shark" style={{ width: "0", maxWidth: "28em", flex: 1, alignSelf: "flex-start" }} />
						...
						<div style={{ flex: "1 1 0", display: "flex", flexDirection: "column", paddingBottom: "2vh" }}>
							...
							<div style={{ display: "flex", alignItems: "center" }}>
								...
								<div style={{ border: "0.2em solid #0E387A", background: "white", padding: "2.5vh 3em", flex: "1 1 0", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "4em", borderRadius: "1em", overflow: "hidden" }}>
									<p style={{ fontSize: "2.33em", fontWeight: 800, color: "rgb(216,129,39)", textAlign: "center", lineHeight: 1.4 }}>
							...
							{/* Reach out text */}
							<p className="text-center" style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6, marginTop: "3vh" }}>
					...
					{/* Blue callout box */}
					<div style={{ background: "rgba(161,214,233,1)", padding: "2.5vh 3em", borderRadius: "1em", marginBottom: "3vh" }}>
						<p style={{ fontSize: "2.33em", fontWeight: 400, color: "#0E387A", lineHeight: 1.6 }}>
				...
				<div style={{ marginBottom: "5vh" }}>
					<div
						className="flex-col sm:flex-row"
						style={{ display: "flex", gap: "3em", alignItems: "center", marginBottom: "2vh" }}
					>
						<div style={{ flex: "1 1 0" }}>
							<p style={{ fontSize: "2.62em", fontWeight: 700, color: "rgb(46,88,155)", lineHeight: 1.4, marginBottom: "1.5vh" }}>
								2) Get moneyyyy
						...
						<div style={{ flexShrink: 0, width: "26em", position: "relative" }}>
							<img src="/imgs/guide/sponsors-ai.webp" alt="Sponsors" style={{ width: "100%", display: "block" }} />
						</div>
					</div>

					<p className="text-center galindo" style={{ fontSize: "2.33em", fontWeight: 400, color: "#0E387A", lineHeight: 1.4, marginBottom: "3vh" }}>
						Here's how to start:
					</p>
					...
					<div
						className="flex-col sm:flex-row"
						style={{ display: "flex", alignItems: "center", gap: "3em", marginBottom: "3vh" }}
					>

						{/* Surfboard with rotated text overlay */}
						<div style={{ width: "100vw", overflow: "hidden" }}>
							<div style={{ position: "relative", width: "52.7em", left: "50%", transform: "translateX(-50%)" }}>
								<img
									src="/imgs/guide/surfboard-yellow.webp"
									alt=""
									style={{ width: "100%", display: "block" }}
								/>
								<div style={{ position: "absolute", left: "54%", top: "47%", transform: "translate(-50%, -50%) rotate(-7deg)", width: "37em", textAlign: "center" }}>
									<p style={{ fontSize: "2.1em", fontWeight: 700, color: "#0E387A", lineHeight: 1.5 }}>
						...
						<div style={{ flex: "1 1 0" }}>
							<p
								...
								style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6}}
							>
				...
				<div>
					<div style={{ display: "flex", gap: "3em", alignItems: "flex-start", marginBottom: "3vh" }}>
						<p style={{ fontSize: "2.62em", fontWeight: 700, color: "rgb(46,88,155)", lineHeight: 1.4, flexShrink: 0 }}>
							3) Outreach
						</p>
						<p style={{ fontSize: "2.33em", fontWeight: 400, color: "#0E387A", lineHeight: 1.6, flex: "1 1 0" }}>
					...
					<div
						...
						style={{ display: "flex", gap: "3em", alignItems: "center", marginBottom: "3vh" }}
					>
						<div style={{ flexShrink: 0, width: "21.3em" }}>
							<img src="/imgs/guide/outreach-1.webp" alt="" style={{ width: "100%", display: "block" }} />
						</div>
						<p style={{ fontSize: "2em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6, flex: "1 1 0", alignSelf: "center" }}>
					...
					>
						...
						<p style={{ fontSize: "2em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6, alignSelf: "center" }}>
			...
			<div style={{ padding: "4vh 7.4% 5vh" }}>
				<div style={{ marginBottom: "4vh" }}>
					...
					<p style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6, marginBottom: "1.5vh", marginLeft: "3em" }}>
				...
				<div style={{ marginBottom: "4vh" }}>
					...
					<p className="text-center" style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6, marginBottom: "2.5vh", marginLeft: "3em" }}>
					...
					{/* Yellow rules box */}
					<div style={{ background: "rgba(255,226,142,0.7)", padding: "4vh 4em", margin: "0 auto", maxWidth: "74.8em", borderRadius: "1em"}}>
						<p style={{ fontSize: "2.18em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.8, marginBottom: "2.5vh" }}>
						...
						<p style={{ fontSize: "2.18em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.8 }}>
			...
			<div style={{ padding: "0 7.4% 5vh" }}>
				<p style={{ fontSize: "2.62em", fontWeight: 800, color: "rgb(46,88,155)", lineHeight: 1.4, marginBottom: "2vh" }}>
					Resources + Support
				</p>
				<p className="text-center" style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6, marginBottom: "1.5vh" }}>
				...
				<p className="text-center" style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6, marginBottom: "3vh" }}>
				...
				{/* Support table */}
				<div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "1.2em", overflowX: "auto" }}>
					<div style={{ background: "rgb(249,166,54)", padding: "2em", minHeight: "10em", display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "1em" }}>
						<p style={{ fontSize: "2.33em", fontWeight: 600, color: "#0E387A", textAlign: "center" }}>Contact method</p>
					</div>
					<div style={{ background: "rgb(249,166,54)", padding: "2em", minHeight: "10em", display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "1em" }}>
						<p style={{ fontSize: "2.33em", fontWeight: 600, color: "#0E387A", textAlign: "center" }}>Expected response time</p>
					</div>
					<div style={{ background: "rgb(249,166,54)", padding: "2em", minHeight: "10em", display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "1em" }}>
						<p style={{ fontSize: "2.33em", fontWeight: 600, color: "#0E387A", textAlign: "center" }}>When to use</p>
					</div>
					<div style={{ background: "#FFC7DA", padding: "2em", borderRadius: "1em" }}>
						<p style={{ fontSize: "2.13em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6 }}>
				...
				{/* service hours */}
				<div>
					<p style={{ fontSize: "2.62em", fontWeight: 800, color: "rgb(46,88,155)", lineHeight: 1.4, margin: "2vh 0" }}>
						Service Hours
					</p>
					<p className="text-center" style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.6, marginBottom: "1.5vh" }}>
			...
			<div style={{ padding: "0 7.4% 6vh" }}>
				<p style={{ fontSize: "2em", fontWeight: 800, color: "rgb(46,88,155)", lineHeight: 1.4, marginBottom: "2vh" }}>
					What's next?
				</p>
				<p className="text-center" style={{ fontSize: "1.8em", fontWeight: 400, color: "rgb(46,88,155)", lineHeight: 1.7 }}>
					...
					>
						<Image
							...
							height={210}
							alt="apply!"
							className="w-[65em] md:w-[25em] h-auto mx-auto"
							sizes="(max-width: 48em) 65em, 25em"
						/>
					</a>
					<br></br>
