...
export const sunriseSteps: SunriseStep[] = [
	...
	},
	{
		...
		screenshot: "/imgs/step7.png",
	},
	{
		id: 8,
		slug: "step8",
		title: "Checkout your Website",
		goal: "Open the website and make sure everything so far is displayed",
		estimatedTime: "3 min",
		milestoneComplete: null,
		checklist: [
		...
		screenshot: "/imgs/step8.png",
	},
	{
		id: 9,
		slug: "step9",
		title: "Add classes to Divs",
		goal: "Add classes to divs so they can later be used for styling",
		estimatedTime: "4 min",
		milestoneComplete: null,
		checklist: [
			"Add a class to the link",
			"Add a class to the small heading.",
			"Add a class to the image.",
		],
		screenshot: "/imgs/step9.png",
	},
	{
		id: 10,
		slug: "step10",
		...
		screenshot: "/imgs/step10.png",
	},
	{
		id: 11,
		slug: "step11",
		title: "Link the CSS file",
		goal: "Add the link to connect CSS with HTML",
		estimatedTime: "2 min",
		milestoneComplete: null,
		checklist: ["Add a link to connect HTML with the CSS"],
		screenshot: "/imgs/step11.png",
	},
	{
		id: 12,
		slug: "step12",
		title: "Start CSS base styles",
		goal: "Set default font, alignment, and sizes.",
		estimatedTime: "5 min",
		milestoneComplete: null,
		checklist: [
			"Set all font family to sans-serif.",
			"Set main container to be centered aligned by making it display flex.",
			"Set the image width to be 500px",
		],
		screenshot: "/imgs/step12.png",
	},
	{
		id: 13,
		slug: "step13",
