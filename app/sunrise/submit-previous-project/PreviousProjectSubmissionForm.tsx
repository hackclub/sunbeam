...
export default function PreviousProjectSubmissionForm({
	profile,
}: SubmissionFormProps) {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			const res = await fetch("/api/submit-previous-project", {
				method: "POST",
								...
								<>
									...
									>
										...
										{/* <button
											type="submit"
											disabled={loading}
											className="mt-[1vh] w-full bg-[#359bbf] hover:bg-[#2a7fa3] text-white font-semibold py-[1vh] px-[2vh] rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed outfit text-[0.95rem]"
										>
