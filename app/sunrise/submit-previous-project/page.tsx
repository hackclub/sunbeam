...
import PreviousProjectSubmissionForm from "./PreviousProjectSubmissionForm";
...
export default async function SubmitPreviousProjectPage() {
	const cookieStore = await cookies();
	const token = cookieStore.get("sunrise_token")?.value;

	if (!token) {
		redirect("/sunrise/previous-project");
	}
	...
	return <PreviousProjectSubmissionForm profile={profile} />;
}
