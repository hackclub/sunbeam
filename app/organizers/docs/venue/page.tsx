  ...
  return (
    <DocsPage>
      <div>
        ...
        <p className="text-center" style={{ fontSize: "2.33em", fontWeight: 400, color: "rgb(46, 88, 155)", lineHeight: 1.6 }}>
        ...
        {/* table */}
        <div style={{ border: "0.2em solid #0E387A", borderRadius: "1em", overflow: "hidden" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr 1.4fr" }}>
            <div style={{ backgroundColor: "rgba(249,166,54,1)", padding: "1.5vh 1.5em", display: "flex", alignItems: "center", justifyContent: "center", borderRight: "0.2em solid #0E387A", borderBottom: "0.2em solid #0E387A" }}>
              <p style={{ fontSize: "1.8em", fontWeight: 500, color: "#0E387A", textAlign: "center" }}>Space Type</p>
            </div>
            <div style={{ backgroundColor: "rgba(249,166,54,1)", padding: "1.5vh 1.5em", display: "flex", alignItems: "center", justifyContent: "center", borderRight: "0.2em solid #0E387A", borderBottom: "0.2em solid #0E387A" }}>
              <p style={{ fontSize: "1.8em", fontWeight: 500, color: "#0E387A", textAlign: "center" }}>Why it works</p>
            </div>
            <div style={{ backgroundColor: "rgba(249,166,54,1)", padding: "1.5vh 1.5em", display: "flex", alignItems: "center", justifyContent: "center", borderBottom: "0.2em solid #0E387A" }}>
              <p style={{ fontSize: "1.8em", fontWeight: 500, color: "#0E387A", textAlign: "center" }}>Tip</p>
            </div>

            {[
              {
                title: "Maker<wbr>spaces",
              ...
              const cellStyle = {
                padding: "2vh 1.5em",
                borderBottom: isLast ? undefined : "0.2em solid #0E387A",
                background: "white",
              };
              return (
                <div key={venue.title} style={{ display: "contents" }}>
                  <div style={{ ...cellStyle, borderRight: "0.2em solid #0E387A", display: "flex", alignItems: "center" }}>
                    <p 
                      style={{ fontSize: "1.6em", fontWeight: 700, color: "rgb(46,88,155)", lineHeight: 1.5 }}
                      dangerouslySetInnerHTML={{ __html: venue.title }}
                    ></p>
                  </div>
                  <div style={{ ...cellStyle, borderRight: "0.2em solid #0E387A" }}>
                    <p style={{ fontSize: "1.5em", fontWeight: 400, color: "#0E387A", lineHeight: 1.5 }}>
                      {venue.desc}
                    </p>
                  </div>
                  <div style={cellStyle}>
                    <p style={{ fontSize: "1.5em", fontWeight: 400, color: "#359BBF", lineHeight: 1.5 }}>
                      {venue.tip}
                    </p>
                  </div>
                </div>
        ...
        <div style={{ padding: "0 7.4% 4vh" }}>
          ...
          <div style={{ marginBottom: "4vh" }}>
            <p style={{ fontSize: "2.62em", fontWeight: 700, color: "#0E387A", lineHeight: 1.4, marginBottom: "1.5vh" }}>
              Step One: Finding someone to contact
            </p>
            <p style={{ fontSize: "2.33em", fontWeight: 400, color: "#0E387A", lineHeight: 1.6, marginBottom: "2vh", marginLeft: "3em" }}>
            ...
            <div style={{ marginTop: "4vh", marginBottom: "4vh" }}>
              <p style={{ fontSize: "2.62em", fontWeight: 700, color: "#0E387A", lineHeight: 1.4, marginBottom: "2vh" }}>
              ...
              <div style={{ border: "0.2em solid #0E387A", marginBottom: "3vh", borderRadius: "1em", overflow: "hidden" }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
                  <div style={{ backgroundColor: "rgba(249,166,54,1)", padding: "0 2em", height: "4em", display: "flex", alignItems: "center", justifyContent: "center", borderRight: "0.2em solid #0E387A", borderBottom: "0.2em solid #0E387A" }}>
                    <p style={{ fontSize: "1.94em", fontWeight: 500, color: "#0E387A", textAlign: "center" }}>DON'T ❌</p>
                  </div>
                  <div style={{ backgroundColor: "rgba(243,147,180,1)", padding: "0 2em", height: "4em", display: "flex", alignItems: "center", justifyContent: "center", borderBottom: "0.2em solid #0E387A" }}>
                    <p style={{ fontSize: "1.94em", fontWeight: 500, color: "#0E387A", textAlign: "center" }}>DO ✅</p>
                  </div>
                  <div style={{ backgroundColor: "white", padding: "2em 1em 2em 1.5em", borderRight: "0.2em solid #0E387A" }}>
                  ...
                  <div style={{ backgroundColor: "white", padding: "2em 1em 2em 1.5em" }}>
                    <ul style={{ listStyleType: "disc", paddingLeft: "1.5em" }}>
                      <li style={{ fontSize: "1.94em", fontWeight: 400, color: "#0E387A", lineHeight: 1.6 }}>
              ...
              <p className="text-center" style={{ fontSize: "2.04em", fontWeight: 400, color: "#359BBF", lineHeight: 1.6, marginBottom: "3em" }}>
              ...
              {/* shark bubble txt */}
              <div style={{ display: "flex", alignItems: "center", gap: "2em", marginBottom: "2vh" }}>
        ...
        <div style={{ padding: "0 7.4% 4vh" }}>
          <div style={{ marginBottom: "3vh" }}>
            <p style={{ fontSize: "2.33em", fontWeight: 700, color: "#0E387A", lineHeight: 1.4, marginBottom: "1vh" }}>
          ...
          <div>
            <p style={{ fontSize: "2.33em", fontWeight: 700, color: "#0E387A", lineHeight: 1.4, marginBottom: "1.5vh" }}>
              If you get ghosted: <span style={{fontWeight: 400}}>follow. up.</span>
            </p>
            <div style={{ background: "#9CD4E7", padding: "2.5vh 3em", borderRadius: "1em", marginLeft: "3em" }}>
              <ul style={{ listStyleType: "disc", paddingLeft: "3em" }}>
                <li style={{ fontSize: "2.13em", fontWeight: 400, color: "#0E387A", lineHeight: 1.6 }}>
                  Follow-up every 3-5 business days! Reach out to another employee! Call them!
                </li>
                <li style={{ fontSize: "2.13em", fontWeight: 400, color: "#0E387A", lineHeight: 1.6, marginTop: "1.5vh" }}>
